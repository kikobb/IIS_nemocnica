<div class="col-sm-8 ">
    ...
    {{ Form::open(['route' => 'vyhladavanie.store', 'method' => 'post', 'class' => 'form']) }}
        ...
        <div class="form-group">
                ...
                'oddelenie' => 'Oddelenie',
                'datum_prichodu' => 'Dátum príchodu (Formát - 1999-12-31)',
                'datum_odchodu' => 'Dátum odchodu (Formát - 1999-12-31)',
                'rodne_cislo' => 'Pacient - rodné číslo',
                'nazov' => 'Názov',
                'latka' => 'Účinná látka',
                'typ' => 'Typ',
                'cas' => 'Dátum (Formát - 1999-12-31)',
                'poschodie' => 'Poschodie',
                'kapacita' => 'Kapacita',
